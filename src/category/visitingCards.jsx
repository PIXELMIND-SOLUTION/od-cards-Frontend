  ...
  return (
    <>
      ...
      <div className="container my-3 my-md-5">
        <h2 className="text-center fw-bold mb-3 mb-md-4" style={{ color: "#DF2C58" }}>Visiting Cards</h2>
                      ...
                      <div className="col-12">
                        ...
                        {Object.keys(selectedProduct)
                          .filter(key => {
                            ...
                            if (['name', 'creasing', 'description', 'image', 'notes', 'id', 'padding', 'quantityDisplay', 'cardSizeMultiplier'].includes(key)) {
                              return false;
                            }
