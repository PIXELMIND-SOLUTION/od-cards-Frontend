...
const FluteBoardPrinting = () => {
  ...
  const transformApiData = (products) => {
    ...
    products.forEach(product => {
      ...
      categoryMap[product.productCategory].products.push({
        ...
        padding: formatArrayProperty(product.padding),
  ...
  const renderField = (product, key) => {
    ...
    if (["boxPacking", "roundCorners", "bigSizeCard"].includes(key)) {
      return (
        <div className="mb-3">
  ...
  return (
    <>
      ...
      <div className="container my-3 my-md-5">
        <h2 className="text-center fw-bold mb-3 mb-md-4" style={{ color: "#DF2C58" }}>Flute Board Printing</h2>
                  ...
                  {categories.map((cat, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`btn btn-sm rounded-pill ${isActive ? 'active text-white' : 'text-danger'
                          }`}
                        style={{
                          whiteSpace: 'nowrap',
                      ...
                      <div className="col-12">
                        ...
                        {Object.keys(selectedProduct)
                          .filter(key => {
                            ...
                            if (['name', 'creasing', 'boxPacking', 'roundCorners', 'bigSizeCard', 'description', 'image', 'notes', 'id', 'padding', 'quantityDisplay', 'cardSizeMultiplier'].includes(key)) {
                              return false;
                            }
...
export default FluteBoardPrinting;