...
const BondPaperJobs = () => {
  ...
  useEffect(() => {
    if (selectedProduct && !productSelections[selectedProduct.id]) {
      const initialSelections = {
        ...
        padding: selectedProduct.padding ? "Yes" : "No",
  ...
  const renderField = (product, key) => {
    ...
    if (["boxPacking", "roundCorners", "bigSizeCard", "padding"].includes(key)) {
      return (
        <div className="mb-3">
  ...
  return (
    <>
      ...
      <div className="container my-3 my-md-5">
        <h2 className="text-center fw-bold mb-3 mb-md-4" style={{ color: "#DF2C58" }}>BondPaper Jobs</h2>
                      ...
                      <div className="col-12">
                        ...
                        {Object.keys(selectedProduct)
                          .filter(key => {
                            ...
                            if (['name', 'creasing', 'boxPacking', 'roundCorners', 'bigSizeCard', 'description', 'image', 'notes', 'id', 'quantityDisplay', 'cardSizeMultiplier'].includes(key)) {
                              return false;
                            }
